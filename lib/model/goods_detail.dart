class GoodsDetailModol {
  String code;
  String message;
  GoodsDetailDataModel data;

  GoodsDetailModol({this.code, this.message, this.data});

  GoodsDetailModol.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new GoodsDetailDataModel.fromJson(json['data']) : null;
  }
...
class GoodsDetailDataModel {
  ...
  GoodsDetailDataModel({this.goodInfo, this.goodComments, this.advertesPicture});

  GoodsDetailDataModel.fromJson(Map<String, dynamic> json) {
